...
class SupportingGoalsCareerView extends GetView<SetFocusGoalController> {
  const SupportingGoalsCareerView({super.key});
              ...
              child: Column(
                ...
                children: [
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                '"Small steps towards big career success."',
                  ...
                  _goalTile(
                    ...
                    'Prepare & start your new venture',
                    onTap: () {
                      // TODO: open detail
                    },
                  ),
                  ...
                  GestureDetector(
                    onTap: () {
                      Get.to(() => const AddCustomGoalPage(category: 'Career'));
                    },
                    child: Container(
