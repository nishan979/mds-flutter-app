...
class SupportingGoalsHealthView extends GetView<SetFocusGoalController> {
  const SupportingGoalsHealthView({super.key});
              ...
              child: Column(
                ...
                children: [
                  ...
                  _goalTile(
                    ...
                    'Improve restorative sleep habits',
                    onTap: () {},
                  ),
                  _goalTile(
                  ...
                  GestureDetector(
                    onTap: () {
                      Get.to(() => const AddCustomGoalPage(category: 'Health'));
                    },
                    child: Container(
